...
<div id="menuConteneur">
	...
	<div id="menuPrincipal2"> <a class="image2" href="#">Votre panier</a> </div>
	<div id="menuPrincipal3"> <a class="image3" href="#">Présentation de la gamme</a> </div>
...
<div id="textes">
	<div id="titre">
		<div id="texteLogoAccueil" style= "z-index: 1000; font-size: 25px"><br><br><br><br><br><br><br><br><br><br><br><br><center>Dessinez et Dégustez
		<br>le Décor de vos Assiettes !
		<br> 
		<h6>Trait Gourmand commercialise ce produit unique et breveté qui a reçu le premier prix au concours de l'innovation agro-alimentaire SUD'INNOV 2012	</h6>
		</center><br></div>
		<div id="titre1" style= "z-index: 1000"><div style="margin-left:12px">Présentation des <br>&nbsp;&nbsp;&nbsp;&nbsp; peintures</div></div>
		<div id="titre2" style= "z-index: 1000"><br><br><br>&nbspVotre panier<br>&nbsp;&nbsp </div>
		<div id="titre3" style= "z-index: 1000; margin-top:20px">&nbsp;Présentation<br>de la gamme</div>
	...
	<div id="texte">
		...
		<div id="texte1" style= "z-index: 1000; font-family: 'Merienda One', cursive;color: #2f2f2f">
			Les petits comme les grands peuvent très facilement décorer les assiettes
			et surprendre leurs convives.<br>
			Faites un décor à leur attention, les occasions ne manquent pas:
			fêtes de familles, repas entre amis ou encore anniversaires.<br><br>
			Nous vous proposons une palette de goûts et de parfums composés à partir de pigments de 
			fruits et d'arômes naturels.
			La conservation s'opère de manière naturelle grâce au vinaigre sucré ou salé.<br><br>
			
			<center><img src="images/imageAccueil.jpg"  border="1" width="400px"></center>
		...
		<div id="texte2" style= "z-index: 1000">
			<div id="contenuAchat" style="height:100%; width:420px; float:left">
				<div id="contenuAchat1" style= "font-family: 'Merienda One', cursive;color: #2f2f2f">
					<div id="etape1" style="height:50px; width:100%; text-align: center"><h2>Notre coffret</h2>
					Composé de 6 pots dont les parfums sont Thé vert, Balsamique, Framboise, Groseille, Curcuma, Thé & Herbes de provence.<br>
					Et de trois pipettes dont les parfums sont Curcuma, Groseille, Balsamique<br><br>
					Fournis: 2 pinceaux et une méthode d'utilisation.<br><br>
					Au prix de 22.50€ TTC
					<img src="images/pots/coffret.jpg"  border="1" width="400px">
					</div>
			...
			<div id="bandeauAchat" style="height:100%; width:175px; float:right">
				<div id="menuAchat">
					<div id="menu1"><a class="achat1" href="#">Coffret</a></div>
		...
		<div id="texte3" style= "font-family: 'Merienda One', cursive;color: #2f2f2f; z-index: 1000">
			<center>
				[gamme]<br>
				Le jeu des couleurs & de parfums;
				Le jaune clair avec le curcuma,
				le rouge framboise, le rose groseille
				le vert thé, la teinte chocolat pour le balsamique.
				Toutes nos peintures culinaires sont analysées et 
				homologuées par laboratoire HAMAC sis à Perpignan.		
			</center>
		</div>
...
<!------------------------------------------------------------Fin galerie JS--------------->		
		<div id="texte5" style= "font-family: 'Merienda One', cursive;color: #2f2f2f; z-index: 1000; text-align:center">
			<h2>Trait Gourmand dans les médias</h2><br>
			...
			<a class="notice" target="_blank" href="presse/brochure.pdf"> Notre brochure</a><br><br>
		</div>
